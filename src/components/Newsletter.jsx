          ...
          <div className="relative flex flex-col lg:flex-row items-center justify-between gap-8">
            ...
            >
              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-medium text-white">
                Stay in the Loop with LinkShelf
              </h2>
              <p className="text-blue-100 text-sm sm:text-lg">
                Get tips for organizing your links, early access to new
                features, and occasional inspiration from fellow content
                curators. No spam, just useful stuff.
              </p>
            </motion.div>
            <motion.div
              variants={fadeIn("left", 0.2)}
            ...
            >
              <input
                ...
                className="flex px-6 py-3 w-full bg-white rounded-l-xl focus:outline-none focus:ring-2 focus:ring-amber-500 transition-all"
              />
              <button className="bg-amber-600 py-4 px-8 rounded-r-xl text-white cursor-pointer group hover:bg-blue-600 hover:shadow-lg transition-colors">
